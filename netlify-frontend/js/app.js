class VoiceAssistant {
    constructor() {
        ...
        this.apiBaseUrl = 'https://voice-l7od.onrender.com';
    ...
    async handlePDFUpload(event) {
        ...
        try {
            const response = await fetch(`${this.apiBaseUrl}/upload_pdf`, {
                method: 'POST',
                body: formData
            });
    ...
    async generateSummary() {
        ...
        try {
            const response = await fetch(`${this.apiBaseUrl}/generate_summary`, {
                method: 'POST',
                headers: {
    ...
    async startQuiz() {
        ...
        try {
            const response = await fetch(`${this.apiBaseUrl}/start_quiz`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async submitAnswer(answer) {
        ...
        try {
            const response = await fetch(`${this.apiBaseUrl}/submit_answer`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },

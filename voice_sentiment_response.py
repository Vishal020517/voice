...
def text_to_speech_gtts(text, lang='en', filename='ai_response_audio.mp3'):
    try:
        ...
        time.sleep(min(5, len(text.split()) * 0.15)) 
    except Exception as e:
        print(f"An error occurred during text-to-speech or audio playback: {e}")
        print("Ensure you have an active internet connection and a compatible audio player installed.")
